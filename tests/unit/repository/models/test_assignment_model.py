...
class TestAssignmentModel:
    ...
    def test_create_assignment_with_defaults(self) -> None:
        ...
        assignment = AssignmentModel(name="Test Assignment", confidence_threshold=0.5)
    ...
    def test_datetime_serialization(self) -> None:
        ...
        assignment = AssignmentModel(name="Test", confidence_threshold=0.8, created_at=now, updated_at=now)
    ...
    def test_model_validation_with_invalid_threshold(self) -> None:
        ...
        data: dict[str, str | float] = {"name": "Test", "confidence_threshold": 1.5}
